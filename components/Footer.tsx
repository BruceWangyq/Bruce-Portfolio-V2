...
const useStyles = makeStyles((theme: Theme) =>
  createStyles({
    root: {
      backgroundColor: theme.palette.type === "dark" ? "#091c34" : "#b9d7ea",
...
function Footer() {
  ...
  const handleFormSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    const url: RequestInfo = "https://formspree.io/f/mdoybdla"!;
    fetch(url, {
      method: "POST",
      body: formData,
      headers: {
            ...
            >
              <Grid container className={classes.leftContainer}>
                <Grid item md={6} sm={6} className={classes.iconsGrid}>
                  ...
                  <Link
                    className={classes.socialItem}
                    href="/assets/Resume_Bruce_Wang.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    color="inherit"
                  >
                  ...
                  >
                    ...
                    <Typography>brucewangyq@gmail.com</Typography>
                  </Link>
                  ...
                  >
                    ...
                    <Typography>343-988-2541</Typography>
                  </Link>
                </Grid>
