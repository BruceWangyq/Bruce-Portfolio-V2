...
function Project({
  ...
  const colorLight = "#b9d7ea";
  const colorDark = "#091c34";
  const useStyles = makeStyles((theme: Theme) =>
    createStyles({
      root: {
        "& strong": {
          // color: darkMode ? "#77f372" : "#0d9d74",
          color: darkMode ? deepOrange.A200 : "#311b92", //theme.palette.secondary.main,
        },
        "& p": {
  ...
  const renderProject = () => (
    ...
    >
      <Container className={classes.container}>
        <Typography variant="h3" align="center" gutterBottom itemProp="name">
          {title}
        </Typography>
        <Grid container>
