...
import { lime, red, deepOrange } from "@material-ui/core/colors";
...
function MyAppWithTheme(props: AppProps) {
  ...
  const theme = createMuiTheme({
    palette: {
      ...
      type: paletteType,
      background: {
        default: paletteType === "dark" ? "#222831" : "#f7fbfc",
        paper: paletteType === "dark" ? "#393e46" : "#d6e6f2",
      },
    },
    overrides: {
      MuiAppBar: {
        colorPrimary: {
          backgroundColor: paletteType === "dark" ? "00adb5" : "#d6e6f2",
          color: paletteType === "dark" ? "#black" : "#eeeeeee",
        },
      },
    },
  });
  ...
  return (
    <>
      <Head>
        ...
        {/* <!-- Primary Meta Tags --> */}
        <meta name="title" content="Bruce Wang" />
        <meta
          name="description"
          content="Hi, I am Bruce Wang, an adventurer in web development."
          key="description"
        />
        ...
        />
        <meta property="og:title" content="Bruce Wang" />
        <meta
        ...
        <meta
          ...
          content={`https://${process.env.NEXT_PUBLIC_VERCEL_URL}`}
        />
        <meta property="twitter:title" content="Bruce Wang" />
        <meta
